{ pkgs, ... }:
let
  fonts = import ../../../station/setup/fonts/fonts.nix;
    ...
    polybar = {
      ...
      config = {
        ...
        "module/music" = {
          type = "custom/script";
          exec =
            "${pkgs.playerctl}/bin/playerctl --follow metadata --format '%{F${clr.basefg}}{{artist}}%{F${clr.base11}}    %{F${clr.base13}}{{title}}%{F-}' 2>/dev/null";
          tail = true;
          format = "<label>";
      ...
      # };
        ...
        "module/overview" = {
          ...
          click-left = "sh /home/$USER/.config/rofi/appmenu";
        };
        ...
        "module/powermenu" = {
          ...
          click-left = "sh ~/.config/nixpkgs/system/apps/scripts/sysmenu";
        };
        ...
        "module/lock" = {
          ...
          content-background = clr.basebg-alt;
          content-foreground = clr.basefg-alt;
          click-left = "betterlockscreen -l dimblur -t Yo !";
        };
      };
    };
  };
